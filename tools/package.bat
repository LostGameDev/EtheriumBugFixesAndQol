...
if %ERRORLEVEL% neq 0 (
    echo ERROR: EtheriumModPackager.exe was not found in your PATH or tools folder.
    echo Please make sure the folder containing EtheriumModPackager.exe is added to your PATH or tools folder.
    exit /b 1
)

REM --- Set the mod directory path ---
set "MOD_DIR=..\bin\Debug\net35"
